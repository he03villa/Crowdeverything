                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-ms-6">
                        <div class="form-group ">
                            ...
                            <select name="text" id="ciudad" class="form-control{{ $errors->has('ciudad') ? ' is-invalid' : '' }}" value="{{ old('ciudad') }}" required autofocus>
                                <option>Seleciones la ciudad de recidencia</option>
                                @include('ciudad.index')
                            </select>
                ...
                <div class="row justify-content-center">
                    <div class="col-ms-6">
                        <div class="form-group">
                            ...
                            <input type="password" name="contrasena" id="contrasena" class="form-control{{ $errors->has('contrasena') ? ' is-invalid' : '' }}" value="{{ old('contrasena') }}" required autofocus>
