        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="row" style="background-color: white; margin-left: 5px">
                    <div class="col-sm-12">
                        <p class="text-justify" style="margin: 10px">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum culpa aliquam hic non dolores, odio, veniam vero saepe minus eveniet fugit esse qui voluptates dicta obcaecati! Ut veritatis commodi adipisci!
                        </p>
                    </div>
                </div>
